            ...
            children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              Theme(
                                ...
                                child: Checkbox(
                                  value: _model.agreeTermsValue ??= false,
                                  onChanged: (newValue) async {
                                    setState(() =>
                                        _model.agreeTermsValue = newValue!);
                                  },
                                  activeColor:
                              ...
                              Expanded(
                                child: Container(
                                  width:
                                      MediaQuery.of(context).size.width * 0.776,
                                  decoration: BoxDecoration(
                                    color: Colors.black,
                                  ),
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        10.0, 0.0, 0.0, 0.0),
                                    child: Text(
                                      'I agree to the EULA, Privacy Policies, and Terms & Conditions of using the app. I am at least 18 years of age.',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    Function() _navigate = () {};
                    if (_model.agreeTermsValue == true) {
                      ...
                      await showDialog(
                        ...
                        builder: (alertDialogContext) {
                          return AlertDialog(
                            ...
                            content: Text(
                                'Please agree to the EULA, Privacy Policies, and Terms & Conditions of using the app'),
                            actions: [
                              TextButton(
                                onPressed: () =>
